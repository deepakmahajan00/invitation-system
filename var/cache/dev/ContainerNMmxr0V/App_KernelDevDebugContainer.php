...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.1_Serializer~OQa25Dn' shared service.
     *
     * @return \Symfony\Component\Serializer\Serializer
     */
    protected function get_1SerializerOQa25DnService()
    {
        return $this->privates['.1_Serializer~OQa25Dn'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['property_info'] ?? $this->getPropertyInfoService()))], [0 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder()))]);
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0GpjJVtqKE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fPLVFXunu6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        $a = ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService());
        $b = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(($this->privates['.1_Serializer~OQa25Dn'] ?? $this->get_1SerializerOQa25DnService())));
        ...
        $j = ($this->privates['api_platform.iri_converter.legacy'] ?? $this->getApiPlatform_IriConverter_LegacyService());
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => $b, 2 => $c, 3 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($d, [], $e), 4 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $e), 5 => $c, 6 => $b, 7 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $i, NULL, $d, NULL, $e), 8 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($f, $j, $d), 9 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($d, true), 10 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), 11 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 12 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 13 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $j, $i, $k, $a, $e, $l, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $m), 14 => new \ApiPlatform\Serializer\ItemNormalizer($g, $h, $j, $i, $a, $e, $l, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f, $m), 15 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 16 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $e), 17 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 22 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 23 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($k, $i, $j, NULL), 'page', 'pagination', $f, $a), $f, $i, ($this->privates['api_platform.filter_locator'] ?? ($this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], [])))), 24 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 25 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($n, $j, $k), 26 => $n], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder())), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
